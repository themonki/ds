		...
		public void actionPerformed(ActionEvent evento)
		{
			if(evento.getSource() == botonIngresar)
			{
				...
				if(nombre == null )
				{
					...
					JOptionPane.showMessageDialog(null,"Login incorrecto por favor intente nuevamente");
				...
				}else
				{
					...
					campoDescripcionPregunta.setText(usuario.getPreguntaSecreta());
			...
			}else if(evento.getSource() == botonCambiarPassword)
			{
				...
				{
					JOptionPane.showMessageDialog(null,"No es la respuesta adecuada por favor intente nuevamente");
			...
			}else if(evento.getSource() == botonGuardar)
			{
				...
				String verificacionPassword =new String(campoVerificarPassword.getPassword());
				System.out.println(password);
				if(password.equals(verificacionPassword))
				{
					usuario.setContrasena(password);
					controladorUsuario.modificarUsuario(usuario);
					JOptionPane.showMessageDialog(null,"Se cambio correctamente la contraseña ahora puede ingresar");
